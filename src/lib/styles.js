...
export const s = {
  ...
  holidayHeader:{background:'#FCEBEB',color:'#A32D2D'},
  holidayCell:{background:'#FDF3F3'},
  holidayDot:{display:'inline-block',width:5,height:5,borderRadius:'50%',background:'#A32D2D',marginLeft:3,verticalAlign:'middle'},
