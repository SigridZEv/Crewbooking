...
projectLabel:{fontSize:10,color:'#555',maxWidth:120,lineHeight:1.3,marginTop:2,wordBreak:'break-word'},  crewGrid:{display:'grid',gridTemplateColumns:'repeat(auto-fill,minmax(200px,1fr))',gap:12},
